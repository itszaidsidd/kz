<html>
	...
	<body>
		<div class="popup">
			...
			<a href="#" class="close-btn" id="login-close-btn" style="background-color:gray;width:75px;margin-top:5px;height:30px"><b><center>Cencel</center></b></a>
			</div>
		</div>
		
		<script>
			
			document.querySelector('#login').addEventListener("click",function popup(){
