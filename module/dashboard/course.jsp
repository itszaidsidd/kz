...
<html>
	...
	<body>
		...
		<div class="dashboard-body">
				...
				<%
					try{
						...
						while(res.next())
						{
							%>
							<tr>
								<td><% out.write(res.getString("course_id")); %></td>
								<td><% out.write(res.getString("course_name")); %></td>
								<td><% out.write(res.getString("author")); %></td>
								<td>
									<form action="editcourse.jsp" style="display:inline">
									<input type=hidden name=id value="<%out.print(res.getString("course_id"));%>" >
						...
						if("delete".equals(del)){
							...
							String q1="delete from course where course_id="+id+"";
			...
			<a href=addnewcourse.jsp><div class=addcourse><i class="fa-solid fa-plus"></i></div></a>
		</div>
	</body>
</html>