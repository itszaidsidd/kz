...
<html>
	...
	<body>
		...
		<div class="dashboard-body">
			<table>
				<caption>List of Feedback</caption>
				<tr>
					<th>Feedback Id</th>
					<th>Content</th>
					<th>Student Id</th>
				...
				<%
					try{
						...
						while(res.next())
						{
							%>
							<tr>
								<td><% out.write(res.getString("f_id")); %></td>
								<td><% out.write(res.getString("f_content")); %></td>
								<td><% out.write(res.getString("std_id")); %></td>
								<td>
									
									<form style="display:inline">
									<input type=hidden name=id value="<%out.print(res.getString("f_id"));%>" >
						...
						if("delete".equals(del)){
							...
							String q1="delete from feedback where f_id="+id+"";
