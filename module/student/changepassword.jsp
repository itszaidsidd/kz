		...
		<div class="nav-ver">
			...
			<div class="nav-ver-body">
				...
				<ul>
					...
					<li style="background-color:rgba(0,0,0,0.3);"><a href="changepassword.jsp"><i class="fa-solid fa-key"></i> Change Password</a></li>
			...
			<div class=form>
				...
				<%		}
						...
						if("Update".equals(submit))
						{
							...
							String q="update student set std_pass='"+pass+"' where std_email='"+email+"'";
							state.executeUpdate(q);
							%>
							<p style="background-color:#bfb; color:green; padding:10; margin:25px 0;border-radius:5px;width:140px;">Update Successfully</p>	
							<%							
						}
					}
					catch(Exception obj)
